 ...
 * Register menu
 */
require get_template_directory() . '/inc/function-menu-register.php';

/**
 * Register Sidebar
 */
require get_template_directory() . '/inc/function-sidebar_register.php';

/**
 * Register customizer
 */
require get_template_directory() . '/inc/function-customizer_register.php';

/**
 * Register custom post
 */
require get_template_directory() . '/inc/function-custompost_register.php';

/**
 * Register taxonomy
 */
require get_template_directory() . '/inc/function-customtaxonomy_register.php';
