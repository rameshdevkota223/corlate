 ...
 * @return void
 */
function corlate_customize_partial_blogname() {
	bloginfo( 'name' );
}
...
function corlate_customize_preview_js() {
	wp_enqueue_script( 'corlate-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
